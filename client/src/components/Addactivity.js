...
const Addactivity = () => {
  ...
  const addActivity = async (e) => {
    ...
    const res = await fetch("/addactivity", {
      method: "POST",
      credentials: "include",
      headers: {
    ...
    if (res.status === 400 || res.status === 422 || !data) {
      window.alert("Add Activity Failed");
      console.log("Add Activity Failed");
    } else {
      // console.log(data);
      window.alert("Add Activity Successfull");
      console.log("Add Activity Successfull");
